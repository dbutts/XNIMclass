...
%             stim(:,2) = stim(:,2)*TB.prescale(2);
            ...
            for x=1:NNx-1
                for y=1:NNy-1                
                    ...
                    lambdasLT = XNIM.BaryCentric(stim(indLT,:), LT(1,:),LT(2,:),LT(3,:)) ;
                    ...
                    lambdasUT = XNIM.BaryCentric(stim(indUT,:), UT(1,:),UT(2,:),UT(3,:)) ;
...
%             plot(TB.gridX(goodpt)/TB.prescale(1,1),TB.gridY(goodpt)/TB.prescale(2,2),'r.');axis equal
    ...
    methods (Static)
        ...
        function Output=SingleTentBasis(stim, TBcenter, TBbase1, TBbase2)
            ...
            flag = XNIM.PointInTriangle(stim, TBcenter(1:2),TBbase1(1:2),TBbase2(1:2));
            Output(flag==0) =0;
        end
